...
const HeaderSection = () => {
  ...
  return (
    <div className="mt-24 flex font-jost flex-col md:flex-row justify-center md:justify-between flex-wrap gap-5 md:gap-10 items-center px-5 md:px-14">
      <div className="flex gap-10 items-center  justify-center md:flex-auto">
        <button
        ...
        <div className="md:hidden flex items-center justify-center relative px-4 ">
          <button
            ...
            className="flex items-center gap-2 text-sm bg-emerald-500 text-white px-3 py-1 rounded"
          >
            <SlidersHorizontal size={18} />
            Filters
          </button>
        </div>
        {showMobileFilters && <MobileFilter />}
      </div>

      <div className=" w-full hidden md:flex md:w-auto   items-center gap-3 md:gap-5 ">
        <input
      ...
      {/* Large screen filters (hidden on small screens) */}
      <div className="hidden md:flex w-full flex-col gap-5 md:flex-row md:w-auto">
        <select
